...
case $OS in
  ...
  'Darwin')
    OS='Mac'
    open -a /Applications/Google\ Chrome.app http://192.168.1.64:8082/demo/app/agent.html;
	  open -a /Applications/Google\ Chrome.app http://192.168.1.64:8082/demo/app/client.html;
    ;;
  'AIX') ;;
